...
package it.zucchetti.packages.servlet.workScheds;
...
@WebServlet("/servlet/workscheds")

public class WorkSchedsIdv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT * FROM Workscheds");
            ...
            while (resultSet.next()) {
                ...
                jsonObj.addProperty("workSchedId", resultSet.getInt("workSchedId"));
