package it.zucchetti.packages.servlet.regions;
...
@WebServlet("/servlet/regions")
public class RegionsIndex extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT * FROM REGIONS ORDER BY NAME ASC");
            ...
            while (resultSet.next()) {
                ...
                jsonObj.addProperty("regionId", resultSet.getInt("regionId"));
                jsonObj.addProperty("countryId", resultSet.getInt("countryId"));
