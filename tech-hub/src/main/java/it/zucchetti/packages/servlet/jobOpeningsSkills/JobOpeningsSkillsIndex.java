package it.zucchetti.packages.servlet.jobOpeningsSkills;
...
@WebServlet("/servlet/jobopeningsskills")
public class JobOpeningsSkillsIndex extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT * FROM jobopeningsskills");
